<table class="table table-bordered text-center table-hover">
    <tbody>
        <tr class="text-bold">
            <td colspan="2">&nbsp;</td>
            <td colspan="5">@lang("exports.ewc.normal.table.headers.export_masses")</td>
        ...
        <tr class="text-bold">
            ...
            <td>@lang("exports.ewc.normal.table.headers.on_site")</td>
        ...
        @foreach($substances as $substance)
            ...
            <tr>
                ...
                <td>{{ $substance->on_site_transfer_mass ?? 0 }}</td>
