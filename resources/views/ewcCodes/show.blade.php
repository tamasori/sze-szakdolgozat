    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr>
                    <td><strong>@lang("ewc-codes.r_sentences")</strong></td>
                    <td>{{ $ewc->r_sentences }}</td>
                </tr>
                <tr>
                    <td><strong>@lang("ewc-codes.c_components")</strong></td>
                    <td>{{ $ewc->c_components }}</td>
                </tr>
                <tr>
                    <td><strong>@lang("ewc-codes.hazardous_reactions")</strong></td>
                    <td>{{ $ewc->hazardous_reactions }}</td>
                </tr>
                <tr>
