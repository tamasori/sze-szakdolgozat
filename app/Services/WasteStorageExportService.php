...
class WasteStorageExportService implements \App\Interfaces\EwcExportInterface
{
    private $year;
    ...
    {
        return view('exports.waste-storage.header', [
            'year' => $this->year,
        ])->render();
    }
    ...
    {
        return view("exports.waste-storage.body", [
            'year'  => $this->year,
            'cars'  => $this->query()->get(),
            'query' => $this->query(),
        ])->render();
    ...
    public function exportAsXlsx()
    {
        return (new NormalExport($this))
            ->download('hulladektarolas_'.$this->year.'.xlsx');
    }

    public function exportAsCsv()
    {
        return (new NormalExport($this))
            ->download('hulladektarolas_'.$this->year.'.csv', \Maatwebsite\Excel\Excel::CSV);
    }
    ...
    public function exportAsPdf()
    {
        ...
        return $pdf->download('hulladektarolas_'.$this->year.'.pdf');
    }
}
