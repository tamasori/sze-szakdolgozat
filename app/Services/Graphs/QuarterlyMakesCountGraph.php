...
class QuarterlyMakesCountGraph
{
    ...
    {
        $thisYear = $this->query()->whereYear("date_of_demolition", Carbon::now()->year)->whereRaw("QUARTER(date_of_demolition) = QUARTER(CURDATE())")->pluck("cars_count", "car_makes.make");
        $prevYear = $this->query()->whereYear("date_of_demolition", Carbon::now()->subYear()->year)->whereRaw("QUARTER(date_of_demolition) = QUARTER(CURDATE())")->pluck("cars_count", "car_makes.make");
